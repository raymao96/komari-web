...
export default function AboutPage() {
  ...
  useEffect(() => {
    fetch(
      "https://raw.githubusercontent.com/raymao96/komari/refs/heads/github-nuomiiiii/README.md"
    )
      .then((res) => res.text())
      .then(setMarkdown);
  }, []);
          ...
          case "readme":
            return (
              <>
                ...
                <a
                  href="https://github.com/raymao96/komari/blob/github-nuomiiiii/README.md"
                  target="_blank"
                  rel="noreferrer"
